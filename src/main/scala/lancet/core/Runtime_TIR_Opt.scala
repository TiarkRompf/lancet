...
trait RuntimeUniverse_TIR_Opt extends Core_TIR_Opt with RuntimeUniverse_TIR {
...
trait Unsafe_Opt extends Unsafe_TIR



class Runtime_Generic(metaProvider: MetaAccessProvider) extends Runtime_TIR(metaProvider) {
